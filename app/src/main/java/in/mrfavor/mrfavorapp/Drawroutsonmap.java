    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        info.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Dialog dialog = new Dialog(Drawroutsonmap.this);
                dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
                dialog.setCancelable(true);
                dialog.setContentView(R.layout.fare_breakup_dialog);
                dialog.show();

                TextView tt = (TextView)dialog.findViewById(R.id.textView5);
                TextView ff = (TextView)dialog.findViewById(R.id.textView12);

                tt.setText("Estimated Time : " + time);
                ff.setText("Total Fare : " + fare);
...
catch (NullPointerException e)
{
    ...
    void getFavlist1()
    {
        ...
        String url = "http://mrfavor.in/myfavour/sharetaxi_status.php";
        StringRequest MyStringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
